...
def getHastagInfo(params):
    ...
    endpointParams['fields'] = 'id,name,user_id'
...
def getHashtagMedia(params):
    """
        ...
        API Endpoints:
            https://graph.facebook.com/{graph-version}/{ig-hashtag}/top_media?user_id={user-id}&fields={fields}
            https://graph.facebook.com/{graph-api-version/{ig-hashtag}/top_media?user_id={user-id}&fields={fields}
    ...
    endpointParams['fields'] = 'id,caption,like_count,media_type,media_url,permalink' # fields to get back
...
#if you want to use the above functions seperately, uncomment the following lines    
...
# hashtagInfoResponse = getHastagInfo( params ) # hit the api for some data!
